...
$santri = mysqli_fetch_array($result, MYSQLI_ASSOC);
// var_dump($data_santri);die;
...
<head>
	...
	<title>Form Edit Santri</title>
</head>
<body>
	<h3>Form Edit Data Santri</h3>
	<p>Isi form di bawah ini</p>

<form method="POST">
  <label for="fname">Nama depan:</label><br>
  <input type="text" id="fname" name="nama_depan" value="<?=$santri['nama_depan']?>"><br><br>

  <label for="lname">Nama belakang:</label><br>
  <input type="text" id="lname" name="nama_belakang" value="<?=$santri['nama_belakang']?>"><br><br>
  ...
  <input type="text" id="phone" name="hp_orangtua" value="<?= $santri['hp_orangtua']?>"><br><br>
  ...
  <textarea id="alamat" name="alamat" rows="4"><?= $santri['alamat']?></textarea><br><br>
